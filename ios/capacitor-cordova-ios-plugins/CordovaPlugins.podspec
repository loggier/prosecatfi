  ...
  Pod::Spec.new do |s|
    ...
    s.source = { :git => 'https://github.com/ionic-team/does-not-exist.git', :tag => '3.6.0' }
    ...
    s.swift_version  = '5.1'
    s.frameworks = 'Security', 'SystemConfiguration', 'AssetsLibrary', 'MobileCoreServices', 'CoreLocation'
  end